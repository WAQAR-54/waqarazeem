                                    ...
                                    <div class="col-lg-5">
                                        <div class="wpo-project-single-content-des-right">
                                            <ul>
                                                ...
                                                <li>Project Type :<span>Softwere Development</span></li>
                                                <li>Duration :<span>6 Month</span></li>
                                                <li>Completion :<span>15 Apr 2025</span></li>
                                                <li>Share :<span>Web App, Marketing</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="wpo-project-single-main-img owl-carousel mt-2">
                                    <img src="assets/images/project-single/4.jpg" alt="">
                                        ...
                                        <div class="row">
                                            <div class="col col-lg-4 col-md-6 col-12">
                                                <div class="wpo-project-item">
                                                    ...
                                                    <div class="wpo-project-text">
                                                        <h2><a href="portfolio-single.php">Arkio - Architecture &
                                            ...
                                            <div class="col col-lg-4 col-md-6 col-12">
                                                <div class="wpo-project-item">
                                                    ...
                                                    <div class="wpo-project-text">
                                                        <h2><a href="portfolio-single.php">Follio - Multipurpose
                                            ...
                                            <div class="col col-lg-4 col-md-6 col-12">
                                                <div class="wpo-project-item">
                                                    ...
                                                    <div class="wpo-project-text">
                                                        <h2><a href="portfolio-single.php">Elito - Creative Portfolio
                                                                HTML5 Template</a></h2>
